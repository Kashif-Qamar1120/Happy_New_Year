...
// const underline2 = new mojs.Shape({
//   parent: document.getElementById("title"),
//   shape: "curve",
//   strokeLinecap: "round",
//   fill: "none",
//   isShowStart: false,
//   strokeWidth: { "1em": "5em" },
//   stroke: "#ffffff", // Different color for distinction
//   strokeDasharray: "200%",
//   strokeDashoffset: { "200%": "100%" },
//   radius: 170,
//   radiusY: 10,
//   y: "2.5em", // Positioned below the first underline
//   x: "6.0em", // Aligned with the first underline
//   angle: -10,
//   duration: 2000,
//   delay: 1000 // Slight delay to start after the first underline
// }).then({
//   strokeWidth: { "5em": "1em" },
//   strokeDashoffset: { "100%": "-200%" },
//   duration: 2000,
...
// // Combine both underlines into a single timeline
// const timelineText1 = new mojs.Timeline({
//   repeat: 2018 // Infinite repetition
// }).add( underline2).play();
